package com.flaircode.locres.ctrl
{
	...
	public class AppController
	{
		...
		{
			Application.application.addEventListener(FlexEvent.CREATION_COMPLETE, onCC);
			Application.application.addEventListener(Event.CLOSING, onClosing);
		}
		
		public function onCC(event:FlexEvent):void
		{
			FlaircodeUtils.centerToScreen(Application.application.nativeWindow);
		...
		{
			var nw:NativeWindow = Application.application.nativeWindow;
			if(!model.maximized)
			{
